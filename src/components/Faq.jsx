    ...
    return (
        <Container maxWidth="lg">
            ...
            <Accordion expanded={expanded === 'panel1'} onChange={handleChange('panel1')}>
                ...
                <Typography variant='h6'>A quoi ça sert ? #1</Typography>
                </AccordionSummary>
                <AccordionDetails>
                <Typography>
            ...
            <Accordion expanded={expanded === 'panel2'} onChange={handleChange('panel2')}>
                ...
                <Typography variant='h6'>Comment faire une recherche ? #2</Typography>
                </AccordionSummary>
                <AccordionDetails>
                <Typography>
            ...
            <Accordion expanded={expanded === 'panel3'} onChange={handleChange('panel3')}>
                ...
                <Typography variant='h6'>Puis-je chercher n'importe quel terme ? #3</Typography>
                </AccordionSummary>
                <AccordionDetails>
                <Typography>
                    Oui, c'est fou.
